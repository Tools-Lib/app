	...
	<div class="container-fluid">
		...
		<div class="row h-100">
			...
			<div class="col-4 mx-auto my-auto text-white d-none d-md-block d-lg-block d-xl-block" style="z-index:6;margin-right: -200px !important;">
				<h1 style="font-weight: bold;background: -webkit-linear-gradient(180deg, #045de9 0%, #09c6f9 74%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;font-family: 'Helvetica Neue Bold';">Tools Library</h1>
				<h4>Where you can find all the<br>tools you want.</h4>
			</div>
			<div class="bg-light text-center my-auto mx-auto pt-3 pb-4" style="border-radius: 2px;box-shadow: 0px 0px 10px rgba(0,0,0,0.8);z-index: 6;padding-right: 40px;padding-left: 40px;">
				...
				<div id="formLogin" class="form-group">
					<input type="text" name="username" id="user" required="" placeholder="Username, Email Address" class="form-control mb-3 regular-input">
					<input type="password" id="pass" name="password" required="" placeholder="Password" class="form-control mb-3 regular-input">
					...
					<input type="submit" value="Sign in" id="submit" class="btn btn-sm pl-5 pr-5 mb-3 btn-primary regular-submit" id="submit" onclick="login();"><br>
